...
<template>
    <BasePopUp
        ...
        scrollable
    >
        <div slot="Content" class="d-flex flex-wrap">
                    ...
                    <v-card-text>
                        <div slot="body">
                            <v-row dense>
                                ...
                                <v-col
                                    cols="12"
                                    v-if="item.coincidence.length > 0"
                                >
                                    <CoincidenceCardViewComponent
                                ...
                                <v-col cols="12" v-if="item.workExp.length > 0">
                                    <StatusCardViewComponent
                                        title="Exp. Laboral"
                                ...
                                <v-col
                                    cols="12"
                                    v-if="item.psychometric.length > 0"
                                >
                                    <StatusCardViewComponent
                                        title="Psicométricos"
