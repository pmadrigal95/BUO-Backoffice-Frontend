<script>
/**
 * Descripción: Pantalla ActionDialogFilterViewComponent
 *
 * @displayName ActionDialogFilterViewComponent
 *
 */
...
export default {
    name: 'ActionDialogFilterViewComponent',
    ...
    methods: {
            ...
            switch (true) {
                ...
                case row.length > 0:
                    this.$_sendToApi({
                        ...
                        isDelete: false,
                        accionIds: row.map((element) => element.id),
                    });
                    break;
            }
        },
        ...
        $_sendToApi(request) {
            httpService
                .post('perfil/handleActions', request)
                .then((response) => {
